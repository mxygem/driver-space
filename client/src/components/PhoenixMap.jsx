    ...
    >
      ...
      {markers.map((marker) => {
        ...
        return (
          ...
          >
            <circle r="112" className="driver-marker-pulse" />
            <circle r="56" className="driver-marker-dot" />
            {marker.name && (
              <text y="0" dominantBaseline="middle" textAnchor="middle" className="driver-marker-label">
                {marker.name}
              </text>
            )}
          </g>
